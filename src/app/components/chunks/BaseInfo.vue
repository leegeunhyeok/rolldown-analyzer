...
const normalizedImports = computed(() =>
  Array.isArray(props.chunk.imports) ? props.chunk.imports.length : props.chunk.imports,
);
const normalizedModules = computed(() =>
  Array.isArray(props.chunk.modules) ? props.chunk.modules.length : props.chunk.modules,
);
</script>
  ...
  <component
    ...
    :to="
      link
        ? typeof link === 'string'
          ? link
          : { path: route.path, query: { chunk: chunk.chunk_id } }
        : undefined
    "
