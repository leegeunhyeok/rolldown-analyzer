...
import {
  ...
  useGraphDraggingScroll,
  useGraphZoom,
  useModuleGraph,
  useToggleGraphNodeExpanded,
  ...
  >
    ...
    >
      ...
      >
          ...
          <g>
            <template v-for="link of links" :key="link.id">
              <slot
                ...
                :link-class="getModuleGraphLinkColor<T, I>(link)"
              >
                <path
                  :key="link.id"
                  :d="generateModuleGraphLink<T, I>(link, spacing)!"
        ...
        <template v-for="node of nodes" :key="node.data.module.id">
            ...
            >
              ...
              <div class="w-4">
                <button
                  ...
                  :class="{
                    'cursor-not-allowed': isGraphNodeToggling,
                    'hover:bg-active': !isGraphNodeToggling,
                  }"
                ...
                >
                  <div
                    ...
                    :class="[node.data.expanded ? 'i-ph-minus' : 'i-ph-plus']"
    ...
    <div fixed right-6 bottom-6 z-panel-nav flex="~ col gap-2 items-center">
      ...
      <div bg-glass rounded-full border border-base shadow flex="~ col gap-1 p1">
        <template v-if="expandControls">
          <button
            ...
            :disabled="isGraphNodeToggling"
            :class="{
              'op50 cursor-not-allowed': isGraphNodeToggling,
              'hover:bg-active': !isGraphNodeToggling,
            }"
            title="Expand All"
            @click="expandAll()"
