...
<template>
  <div flex="~ col w-full">
    ...
    <div select-none h-full of-auto ws-nowrap w-auto of-visible p4 flex="~ col">
      <div flex="~">
        <FlowmapNode :active="false" class-node-inner="w60">
          <template #content>
      ...
      <div flex="~ items-center justify-center" relative w-60 h14>
        ...
        <span op50 text-xs flex="~ items-center justify-center gap-1" h6>
          ...
          <time v-if="startTime" :datetime="new Date(startTime).toISOString()">{{
      ...
      <div flex="~ items-center justify-center" relative w-60 h14>
        ...
        <span op50 text-xs flex="~ items-center justify-center gap-1" h6>
          ...
          <time v-if="endTime" :datetime="new Date(endTime).toISOString()">{{
